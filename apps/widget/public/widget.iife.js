(function () {
  "use strict";
  const o = {
      WIDGET_URL: "https://vocali-widget.vercel.app",
  ...
  (function () {
    ...
    if (c)
      ...
      const i = document.querySelectorAll('script[src*="embed"]'),
        s = Array.from(i).find((d) => d.hasAttribute("data-organization-id"));
      s &&
    ...
    if (!r) {
      console.error(
        "Vocali Widget: data-organization-id attribute is required"
      );
      return;
    }
    function h() {
    ...
    ((window.VocaliWidget = { init: v, show: m, hide: p, destroy: x }), h());
  })();
})();
